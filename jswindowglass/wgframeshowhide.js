...
$(document).ready(function(){
  $('#wgframef1').on('click', function () {
      ...
      var idd = $('#windowframe3 table #innerdiv').css('border-top-color');
     //alert(bag);
      $('#windowframe3').empty();
      ...
      $('#windowframe3 table').css({'border-color': bag, 'background-color': bag1});
      ...
      $('#windowframe3 table #innerdiv').css({'border-color': idd});
...
$(document).ready(function(){
  $('#wgsashframef1').on('click', function () {   
      ...
      $('#windowframe3 table #innerline2').css({'border-color': idd, 'border-bottom-color': 'rgba(255, 0, 0, 0)', 'border-bottom-width': '0px', 'border-left-color': bag1, 'border-right-color': bag1});
      $('#windowframe3 table #innerline3').css({'border-color': bag, 'border-top-color': 'rgba(255, 0, 0, 0)'});
      $('#windowframe3 table #trbefore').css({'background-color': bag});
      $('#windowframe3 #menuvalidcolor').css({'background-color': bag});
