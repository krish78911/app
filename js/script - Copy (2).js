...
$(document).ready(function(){
  $("#frame11").click(function(){
      var bag = $('#frame3').css('background-color');    
      var bag1 = $('#frame3 .glass').css('background-image');
      //var bag1 = $('#frame3').css('background-color');
      var res = (bag1.indexOf("G0.jpg") > -1);
      //alert(res);
    if (bag == 'rgba(0, 0, 0, 0)' /*&& bag == 'rgba(247, 33, 33)'*/)
    {
...
/*Door Button Click Ends*/

/*Glass Button Click*/
   $("#glass11").click(function(){
      var bag = $('#frame3').css('background-color');  
      var bag1 = $('#frame3 #beforecenter .doorimage').css('background-image');  
      var res = (bag1.indexOf("D0.jpg") > -1);
      //alert(bag);
...
/*Panel Button Click*/
  $("#panel11").click(function(){
      ...
      var bag1 = $('#frame3 #beforecenter .doorimage').css('background-image');  
      var res = (bag1.indexOf("D0.jpg") > -1);
      var bagglass = $('#frame3 .glass').css('background-image');
      //var bag1 = $('#frame3').css('background-color');
      var res2 = (bagglass.indexOf("G0.jpg") > -1);
      //alert(bag);
...
$("#frame3").on("click", "#beforecenter", function () {
 ...
 if (evt.cancelBubble!=null) evt.cancelBubble = true;
    ...
    $("#frame3").on("click", "#table23, #table2", function () {
       var bag = $('#frame3').css('background-color');  
      var bag1 = $('#frame3 #beforecenter .doorimage').css('background-image');  
      var res = (bag1.indexOf("D0.jpg") > -1);
      var bagglass = $('#frame3 .glass').css('background-image');
