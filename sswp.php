...
<body>
  ...
  <option value="Wicklow">Wicklow</option>
     ...
     <!--//$_SESSION["favcolor"] =  $_POST['fname'];-->
     <a href='http://lodgetrade.com/app/windowpatio.php' ><div type='text' style="text-align:center; float:left; margin-right:10px; line-height:40px; font-size:22px;" id="submitform">Make New</div> </a>
     </form>
     </div>
