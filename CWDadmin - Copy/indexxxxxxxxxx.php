        ...
        <table style="background-color:#fff; width:100%;"><tr>
            <td style="background-color:#00670b; width:15%;">
                ...
                <div style="overflow-y: scroll; height:500px;">
                    ...
                    <input type="button" id="countybutton3" class="buttonscounty1" name="buttonname" value="Carlow"><br>
                    <input type="button" id="countybutton4" class="buttonscounty" name="buttonname" value="Cavan"><br>
                    <input type="button" id="countybutton5" class="buttonscounty1" name="buttonname" value="Clare"><br>
                    <input type="button" id="countybutton6" class="buttonscounty" name="buttonname" value="Cork"><br>
                    <input type="button" id="countybutton7" class="buttonscounty1" name="buttonname" value="Donegal"><br>
                    <input type="button" id="countybutton8" class="buttonscounty" name="buttonname" value="Down"><br>
                    <input type="button" id="countybutton9" class="buttonscounty1" name="buttonname" value="Dublin North"><br>
                    <input type="button" id="countybutton10" class="buttonscounty" name="buttonname" value="Dublin South"><br>
                    <input type="button" id="countybutton11" class="buttonscounty1" name="buttonname" value="Fermanagh"><br>
                    <input type="button" id="countybutton12" class="buttonscounty" name="buttonname" value="Galway"><br>
                    <input type="button" id="countybutton13" class="buttonscounty1" name="buttonname" value="Kerry"><br>
                    <input type="button" id="countybutton14" class="buttonscounty" name="buttonname" value="Kildare"><br>
                    <input type="button" id="countybutton15" class="buttonscounty1" name="buttonname" value="Kilkenny"><br>
                    <input type="button" id="countybutton16" class="buttonscounty" name="buttonname" value="Laois"><br>
                    <input type="button" id="countybutton17" class="buttonscounty1" name="buttonname" value="Leitrim"><br>
                    <input type="button" id="countybutton18" class="buttonscounty" name="buttonname" value="Limerick"><br>
                    <input type="button" id="countybutton19" class="buttonscounty1" name="buttonname" value="Londonderry"><br>
                    <input type="button" id="countybutton20" class="buttonscounty" name="buttonname" value="Longford"><br>
                    <input type="button" id="countybutton21" class="buttonscounty1" name="buttonname" value="Louth"><br>
                    <input type="button" id="countybutton22" class="buttonscounty" name="buttonname" value="Mayo"><br>
                    <input type="button" id="countybutton23" class="buttonscounty1" name="buttonname" value="Meath"><br>
                    <input type="button" id="countybutton24" class="buttonscounty" name="buttonname" value="Monaghan"><br>
                    <input type="button" id="countybutton25" class="buttonscounty1" name="buttonname" value="Offaly"><br>
                    <input type="button" id="countybutton26" class="buttonscounty" name="buttonname" value="Roscommon"><br>
                    <input type="button" id="countybutton27" class="buttonscounty1" name="buttonname" value="Sligo"><br>
                    <input type="button" id="countybutton28" class="buttonscounty" name="buttonname" value="Tipperary"><br>
                    <input type="button" id="countybutton29" class="buttonscounty1" name="buttonname" value="Tyrone"><br>
                    <input type="button" id="countybutton30" class="buttonscounty" name="buttonname" value="Waterford"><br>
                    <input type="button" id="countybutton31" class="buttonscounty1" name="buttonname" value="Westmeath"><br>
                    <input type="button" id="countybutton32" class="buttonscounty" name="buttonname" value="Wexford"><br>
                    <input type="button" id="countybutton33" class="buttonscounty1" name="buttonname" value="Wicklow"><br>
                    </form>
                </div>
            </td>
