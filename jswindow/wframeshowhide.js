...
$(document).ready(function(){
  $('#wframef61').on('click', function () {     
   ...
   'display' : 'none',
     ...
     var bagback = $('#windowframe3 table').css('background-color');
      $('#windowframe3').empty();
      $('#windowframe3').html($('#window61').html());
      //$('#windowframe3 #window3').css({'height':'330px', 'width': '253px'});
      $('#windowframe3').css({'background-image':'none', 'border': '0px solid #fff'});
...
$(document).ready(function(){
  $('#wframef62').on('click', function () {     
   ...
   'display' : 'none',
     ...
     var bagback = $('#windowframe3 table').css('background-color');
      $('#windowframe3').empty();
      $('#windowframe3').html($('#window62').html());
      //$('#windowframe3 #window3').css({'height':'330px', 'width': '253px'});
      $('#windowframe3').css({'background-image':'none', 'border': '0px solid #fff'});
...
$(document).ready(function(){
  $('#wframef63').on('click', function () {     
   ...
   'display' : 'none',
     ...
     var bagback = $('#windowframe3 table').css('background-color');
      $('#windowframe3').empty();
      $('#windowframe3').html($('#window63').html());
      //$('#windowframe3 #window3').css({'height':'330px', 'width': '253px'});
      $('#windowframe3').css({'background-image':'none', 'border': '0px solid #fff'});
...
$(document).ready(function(){
  $('#wframef64').on('click', function () {     
   ...
   'display' : 'none',
     ...
     var bagback = $('#windowframe3 table').css('background-color');
      $('#windowframe3').empty();
      $('#windowframe3').html($('#window64').html());
      //$('#windowframe3 #window3').css({'height':'330px', 'width': '253px'});
      $('#windowframe3').css({'background-image':'none', 'border': '0px solid #fff'});
