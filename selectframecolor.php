...
<body>
    <div id="page11" style="width:400px; margin:20px auto; background-color:#688ccc; border:1px solid #e8e8e8; border-radius:5px;">
     ...
     <div style='margin: 0px auto; background-color: rgba(118, 118, 118, 0); text-align: center; width: 100%; margin-top: 2px;'>
     <p id="frontpagetextheading" style="color:#000;">Select Frame Color <!--<img src="images/sadsmiley.png" style="height:50px; width:50px; margin-top: 20px;">--> </p>
     </div>
</div>
<script>
function funcaa() {
