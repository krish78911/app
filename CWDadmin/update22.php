...
<body BGCOLOR="white">
   ...
   <!-- <nav class="clearfix">  
    ...
    <div id="content">
        ...
        <p id="frametitle1">
            <a href="index.php"> <button id="topmenu3">Home</button> </a>
        Admin Panel
...
$result = mysqli_query($con,"SELECT *FROM backend where county = '".$countynamee."'");
...
echo "<input id='tablerow' style='width:50px; height:30px; text-align:center' type='submit' name='county' value='sub'>";
